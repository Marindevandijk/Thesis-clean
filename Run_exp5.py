...
path =  "Data/tracking_results/FishTank20200213_154940_tracking_results.h5"
...
all_endpoints, all_forces, startpoints, accept_rate = Find_endpoints(S_first, tag="first_half", exp_id=5, fight_id=1)
all_endpoints_last, all_forces_last, startpoints_last, accept_rate_last = Find_endpoints(S_last, tag="last_half", exp_id=5, fight_id=1)
