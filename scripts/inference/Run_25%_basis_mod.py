...
outdir = os.path.join(base_dir, "Results_modbasis", "All_fightbouts_quarters_mod_product")
...
S_q1, descriptor = Run_Force_inference(X_q1, time_idx_q1, K=3, M=4, lam=lam_final)
S_q2, descriptor = Run_Force_inference(X_q2, time_idx_q2, K=3, M=4, lam=lam_final)
S_q3, descriptor = Run_Force_inference(X_q3, time_idx_q3, K=3, M=4, lam=lam_final)
S_q4, descriptor = Run_Force_inference(X_q4, time_idx_q4, K=3, M=4, lam=lam_final)
